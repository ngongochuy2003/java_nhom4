...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
 ...
 <!-- Carousel wrapper -->
  ...
  <div class="card" style="border-style: none;">
    <img style="height:55px; width:64px; margin: auto;" src="">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    ...
    <div class="card-body">
      ...
      <p class="card-text" style="text-align:center">Bảo hành lên đến 12 tháng</p>
    </div>
  </div>
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="">
    <div class="card-body">
      ...
      <p class="card-text" style="text-align:center">Đổi hàng thoải mái trong 30 ngày</p>
            ...
            <div class="container">
             ...
             <div class="row" style="margin-top:25px">            
				<h1 style="text-align:center; width:100%" id="nike">TỦ LẠNH MỚI NHẤT</h1>
                    <div class="col-sm-12">
              ...
              <div class="row" style="margin-top:25px">            
				<h1 style="text-align:center; width:100%" id="adidas">ĐIỀU HOÀ MỚI NHẤT</h1>
                    <div class="col-sm-12">
                        ...
                        <div id="content" class="row">
                            <div class=" col-12 col-md-12 col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <h2 class="card-title show_txt" style="text-align:center; font-size:24pt;">SHOP CHƯA NGHĨ TÊN</h2>
                                        <p style="text-align:center;">Uy tín lâu năm chuyên cung đồ điện tử chất lượng đảm bảo và giá tốt nhất tại Hà Nội, tpHCM.</p>
